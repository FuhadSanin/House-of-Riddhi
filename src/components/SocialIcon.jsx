...
const brandStyles = {
  instagram:
    "bg-gradient-to-br from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] text-white hover:brightness-110",
...
export function SocialLinkButton({ icon, label, href, className }) {
  return (
    <a
      href={href}
      target="_blank"
      ...
      aria-label={label}
      className={cn(
        "flex size-10 items-center justify-center rounded-full shadow-premium-sm transition-all",
        brandStyles[icon],
        className
      )}
    >
      <SocialIcon name={icon} className="size-[1.125rem]" />
    </a>
  );
}
